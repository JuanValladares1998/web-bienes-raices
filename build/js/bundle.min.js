function darkMode(){const e=window.matchMedia("(prefers-color-scheme: dark");!0===e.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode"),e.addEventListener("change",()=>{!0===e.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode")});document.querySelector(".dark-mode-boton").addEventListener("click",()=>{document.body.classList.toggle("dark-mode")})}function eventListeners(){const e=document.querySelector(".boton-menu"),n=document.querySelector(".navegacion");e.addEventListener("click",()=>{esconderMenu()}),n.addEventListener("click",()=>{esconderMenu()})}function esconderMenu(){document.querySelector(".navegacion").classList.toggle("hide")}
